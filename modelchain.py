...
class ModelChain:
    ...
    def run_model(self, weather, module_degradation=None):
        """
        ...
        self.module_degradation = module_degradation
        self._run_from_effective_irrad(weather, module_degradation=module_degradation)
    ...
    def _run_from_effective_irrad(self, data=None, module_degradation=None):
        """
        ...
        if module_degradation is not None:
            if isinstance(self.results.dc, tuple):
                for i in range(len(self.results.dc)):
                    self.results.dc[i]['p_mp'] = self.results.dc[i]['p_mp']*module_degradation
            else:
                self.results.dc['p_mp'] = self.results.dc['p_mp']*module_degradation
